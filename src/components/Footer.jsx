  ...
  return (
    <footer className="bg-dark text-light">
      <div className="container py-5 d-flex justify-content-evenly">
        <div className="mx-3">
          <h3>MECANICA BUSTOS</h3>
          <h6>Taller mecanico y venta de repuestos</h6>
        ...
        <div className="mx-3">
          ...
          <svg
            ...
            height="16"
            fill="currentColor"
            className="footerLogo instagram mx-1"
            viewBox="0 0 16 16"
            onClick={() =>
          ...
          <svg
            ...
            height="16"
            fill="currentColor"
            className="footerLogo whatsapp mx-1"
            onClick={() =>
              window.open(
                "https://api.whatsapp.com/send/?phone=542346692348&text&type=phone_number&app_absent=0",
                "_blank"
              )
            }
            viewBox="0 0 16 16"
          ...
          <svg
            ...
            height="16"
            fill="currentColor"
            className="footerLogo facebook mx-1"
            onClick={() =>
                window.open(
                  "https://www.facebook.com/tallermecanicobustos/",
                  "_blank"
                )
              }
            viewBox="0 0 16 16"
